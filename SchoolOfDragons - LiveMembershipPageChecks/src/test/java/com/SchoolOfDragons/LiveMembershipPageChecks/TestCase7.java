...
public class TestCase7
{
	...
	{
		logger = report.startTest("Test Case 7 : Live - Verify Membership page - Three Months Select a Payment Method DB and Visa Form","This will verify Three Months membership Select a Payment DB and Three Months Visa Form contents");		
		...
		membershipPage.verifyThreeMonthsSelectPaymentMethodDBandPaymentFormVisa(logger);	
