...
public class TestCase11
{
	...
	{
		logger = report.startTest("Test Case 11 : Live - Verify Membership page - Three Months Select a Payment Method DB and MasterCard Form","This will verify Three Months membership Select a Payment DB and Three Months MasterCard Form contents");		
		...
		membershipPage.verifyThreeMonthsSelectPaymentMethodDBandPaymentFormMasterCard(logger);	
