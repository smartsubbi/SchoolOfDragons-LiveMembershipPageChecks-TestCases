...
public class TestCase8
{
	...
	{
		logger = report.startTest("Test Case 8 : Live - Verify Membership page - Six Months Select a Payment Method DB and Visa Form","This will verify Six Months membership Select a Payment DB and Six Months Visa Form contents");		
		...
		membershipPage.verifySixMonthsSelectPaymentMethodDBandPaymentFormVisa(logger);	
