...
public class TestCase5
{
	...
	{
		logger = report.startTest("Test Case 5 : Live - Verify Membership page - Three Months Select a Payment Method DB and PayPal Page","This will verify Twelve Months membership Select a Payment DB and Monthly Paypal Page contents");		
		...
		membershipPage.verifyTwelveMonthsSelectPaymentMethodDBandPaymentFormPayPal(logger);	
