...
public class TestCase4
{
	...
	{
		logger = report.startTest("Test Case 4 : Live - Verify Membership page - Six Months Select a Payment Method DB and PayPal Page","This will verify Six Months membership Select a Payment DB and Monthly Paypal Page contents");		
		...
		membershipPage.verifySixMonthsSelectPaymentMethodDBandPaymentFormPayPal(logger);	
