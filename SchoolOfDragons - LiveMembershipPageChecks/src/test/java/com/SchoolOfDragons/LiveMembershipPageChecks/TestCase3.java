...
public class TestCase3
{
	...
	{
		logger = report.startTest("Test Case 3 : Live - Verify Membership page - Three Months Select a Payment Method DB and PayPal Page","This will verify Three Months membership Select a Payment DB and Three Months Paypal Page contents");		
		...
		membershipPage.verifyThreeMonthsSelectPaymentMethodDBandPaymentFormPayPal(logger);	
