...
public class TestCase2
{
	...
	{
		logger = report.startTest("Test Case 2 : Live - Verify Membership page - Monthly Select a Payment Method DB and PayPal Page","This will verify monthly membership Select a Payment DB and Monthly Paypal Page contents");		
		...
		membershipPage.verifyMonthlySelectPaymentMethodDBandPaymentFormPayPal(logger);	
	...
	public void printReportPath() throws Throwable
	{
		...
		String mailContent ="You can refer to the below report path for the run result : \n"+emailReportPathToSend+
				...
				"\n ========================================================================================================"+
				"\n\n Test Case 2 : Live - Verify Membership page - First Membership Option ("+MembershipPage.oneMonthExpectedPrice+") Verify Select Payment DB and PaPal Page : "+TestCase2.testCase2Result+
		        "\n\n Test Case 3 : Live - Verify Membership page - Second Membership option ("+MembershipPage.threeMonthsExpectedPrice+") Verify Select Payment DB and PaPal Page : "+TestCase3.testCase3Result+
		        "\n\n Test Case 4 : Live - Verify Membership page - Third Membership option ("+MembershipPage.sixMonthsExpectedPrice+") Verify Select Payment DB and PaPal Page : "+TestCase4.testCase4Result+
		        "\n\n Test Case 5 : Live - Verify Membership page - Fourth Membership option ("+MembershipPage.twelveMonthsExpectedPrice+") Verify Select Payment DB and PaPal Page : "+TestCase5.testCase5Result;	     
		String mailSubject = "School Of Dragons - Live - Verify Membership Page - Select Payment Method DB and PayPal Page for all Membership Options";
