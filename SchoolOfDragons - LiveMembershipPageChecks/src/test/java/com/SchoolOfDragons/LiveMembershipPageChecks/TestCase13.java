...
public class TestCase13
{
	...
	{
		logger = report.startTest("Test Case 13 : Live - Verify Membership page - Twelve Months Select a Payment Method DB and MasterCard form","This will verify Twelve Months membership Select a Payment DB and Twelve Months MasterCard Form contents");		
		...
		membershipPage.verifyTwelveMonthsSelectPaymentMethodDBandPaymentFormMasterCard(logger);	
	...
	public void afterTest(ITestResult result) throws Throwable
	{
		...
		{		
			...
			testCase13Result = "false";					
		}		
		testCase13Result = "true";
	}
